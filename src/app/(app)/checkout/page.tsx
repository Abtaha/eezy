  ...
  if (cart.length === 0) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-16 text-center">
        ...
        <p className="mb-8 text-gray-600">Add some items to your cart to checkout!</p>
        <Button onClick={() => router.push("/store")} className="rounded-full bg-black hover:bg-gray-800">
          Continue Shopping
        </Button>
      </div>
    );
    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1">
          <form onSubmit={handlePlaceOrder} className="rounded-xl border bg-white p-6 shadow-sm">
